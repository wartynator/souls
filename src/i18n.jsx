...
const en = {
  ...
  searchActions: "Search services",
  searchWorklist: "Search jobs",
  ...
  emptyNoActionsTitle: "No services yet",
  emptyNoActionsText: "Add the services you offer — repairs, installations, maintenance. You'll pick from these when logging a job.",
  emptyNoWorklistTitle: "No jobs yet",
  ...
  companyNamePlaceholder: "e.g. TERMOS s.r.o.",
  companyStreetPlaceholder: "Street and number",
  companyCityPlaceholder: "City / ZIP",
  companyCountry: "Country",
  companyCountryPlaceholder: "e.g. Slovakia",
  companyPhonePlaceholder: "+421 ...",
  ...
  actionFormNew: "New service",
  actionFormEdit: "Edit service",
  ...
  filterAll: "All",
  // worklist form
  worklistFormNew: "New job",
  worklistFieldStatus: "Status",
  worklistFormEdit: "Edit job",
  ...
  reportSignatureTech: "Technician",
  reportSignatureCustomer: "Customer",
  reportSignatureDate: "Date",
  worklistFieldActionType: "Type of work",
  worklistNoActions: "Create services in the Services tab first",
  worklistPickAction: "Pick a service…",
  worklistNewContact: "+ New contact",
  worklistNewDevice: "+ New device",
  worklistNewService: "+ New service",
  worklistCreateNamed: "+ Create “{name}”",
  ...
  repeatShortcut:    "Repeat",
  repeatNone:        "No repeat",
  repeat1Month:      "In 1 month",
  repeat3Months:     "In 3 months",
  repeat6Months:     "In 6 months",
  repeat1Year:       "In 1 year",
  dashDueSoon:       "Due soon",
  dashNoDueSoon:     "No upcoming services",
  dueSoonToday:      "today",
  dueSoonOverdue:    "overdue",
  dueSoonDays:       "in {n} days",
  // confirm dialog
...
const sk = {
  ...
  emptyNoActionsTitle: "Zatiaľ žiadne služby",
  emptyNoActionsText: "Pridajte služby, ktoré ponúkate – opravy, inštalácie, údržbu. Vyberiete si z nich pri zázname zákazky.",
  ...
  companyNamePlaceholder: "napr. TERMOS s.r.o.",
  companyStreetPlaceholder: "Ulica a číslo",
  companyCityPlaceholder: "Mesto / PSČ",
  companyCountry: "Krajina",
  companyCountryPlaceholder: "napr. Slovensko",
  companyPhonePlaceholder: "+421 ...",
  ...
  // action form / device action form
  actionFormNew: "Nová služba",
  actionFormEdit: "Upraviť službu",
  ...
  reportSignatureTech: "Technik",
  reportSignatureCustomer: "Zákazník",
  reportSignatureDate: "Dátum",
  worklistFieldActionType: "Typ práce",
  worklistNoActions: "Najprv vytvorte služby na karte Služby",
  worklistPickAction: "Vyberte službu…",
  worklistNewContact: "+ Nový kontakt",
  worklistNewDevice: "+ Nové zariadenie",
  worklistNewService: "+ Nová služba",
  worklistCreateNamed: "+ Vytvoriť „{name}“",
  ...
  calendarToday:     "Dnes",
  calendarNoEntries: "Žiadne záznamy",
  fieldNextService:  "Ďalší servis",
  repeatShortcut:    "Opakovať",
  repeatNone:        "Bez opakovania",
  repeat1Month:      "Za 1 mesiac",
  repeat3Months:     "Za 3 mesiace",
  repeat6Months:     "Za 6 mesiacov",
  repeat1Year:       "Za 1 rok",
  dashDueSoon:       "Čoskoro splatné",
  dashNoDueSoon:     "Žiadne nadchádzajúce servisy",
  dueSoonToday:      "dnes",
  dueSoonOverdue:    "po termíne",
  dueSoonDays:       "o {n} dní",
  // confirm dialog
