  ...
  return (
    <div className="cal">
      ...
      <div className="cal__nav">
        <div className="cal__nav-arrows">
          <button type="button" className="cal__nav-arrow" onClick={goPrev} aria-label="Previous month">
          ...
          <button type="button" className="cal__nav-arrow" onClick={goNext} aria-label="Next month">
